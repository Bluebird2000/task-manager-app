...
const backgrounds = [
  {
    ...
    description:
      "We profer real time solutions to cogs through automation with respect to time as the core value in ascertaining absolute relief from psychological stress",
      ...
      <Block safe>
        ...
        <Block flex={false} center bottom margin={60}>
          ...
          <Button
            ...
            onPress={() => navigation.navigate("ProjectController")}
          >
            <Text
              center
              white
